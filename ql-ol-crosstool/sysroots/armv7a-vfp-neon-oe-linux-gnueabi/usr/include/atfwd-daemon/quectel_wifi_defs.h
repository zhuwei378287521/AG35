...
#define QWIFI_CFG_PATH                          "/data/misc/wifi"
#define QWIFI_TMP_PATH                          "/tmp"
...
#define QWIFI_HOSTAP_CONF_FILE                  QWIFI_CFG_PATH"/hostapd.conf"
#define QWIFI_STA_MODE_HOSTAP_CONF_FILE         QWIFI_CFG_PATH"/sta_mode_hostapd.conf"
#define QWIFI_WPA_SUPPLICANT_CONF_FILE          QWIFI_CFG_PATH"/wpa_supplicant.conf"
#define QWIFI_WPA_SUPPLICANT_CONF_FILE_TEMP     QWIFI_TMP_PATH"/wpa_supplicant.conf"
#define QWIFI_HOSTAP_ACCEPT_FILE                QWIFI_CFG_PATH"/hostapd.accept"
#define QWIFI_HOSTAP_DENY_FILE                  QWIFI_CFG_PATH"/hostapd.deny"
#define QWIFI_HOSTAP_CONF_BAK                   QWIFI_CFG_PATH"/hostapd.conf.bak"
#define QWIFI_HOSTAP_CONF_FILE_FACTORY          QWIFI_CFG_PATH"/hostapd-factory.conf"
#define QWIFI_HOSTAP_CONF_FILE_TEMP             QWIFI_TMP_PATH"/hostapd.conf.tmp"
#define QWIFI_HOSTAP_ACCEPT_FILE_BAK            QWIFI_CFG_PATH"/hostapd.accept.bak"
#define QWIFI_HOSTAP_DENY_FILE_BAK              QWIFI_CFG_PATH"/hostapd.deny.bak"

#define QWIFI_HOSTAP_CONF_FILE_LAST             QWIFI_CFG_PATH"/hostapd.conf.1"
#define QWIFI_MOBILEAP_CONF_FILE		        "/data/mobileap_cfg.xml"
#define QWIFI_MOBILEAP_CONF_FILE_TEMP           QWIFI_TMP_PATH"/mobileap_cfg.xml.tmp"
#define QWIFI_MOBILEAP_CONF_FILE_BAK            "/data/mobileap_cfg.xml.bak"

/*wlan0 mac*/
#define QWIFI_WLAN_MAC_CONF_FILE_LINK		    "/firmware/image/bdwlan.bin"
#define QWIFI_WLAN_MAC_CONF_FILE		        QWIFI_CFG_PATH"/bdwlan.bin"
#define QWIFI_WLAN_MAC_CONF_FILE_TEMP		    QWIFI_TMP_PATH"/bdwlan.bin.tmp"
/*TCP*/
...
#define PORTAL_GATEWAY_CONF_FILE_SAMPLE         "/etc/portal-gateway.conf.sample"
#define PORTAL_GATEWAY_CONF_FILE	            QWIFI_CFG_PATH"/portal-gateway.conf"
#define PORTAL_GATEWAY_CONF_FILE_TEMP           QWIFI_TMP_PATH"/portal-gateway.conf.tmp"
#define PORTAL_ENABLE_FLAG_FILE		            QWIFI_CFG_PATH"/portal-enabled"

#define QWIFI_HOSTAPD_ERROR_COUNT_FILE          QWIFI_CFG_PATH"/hostapd_count.txt"

#define QWIFI_CFG_FILE                          QWIFI_CFG_PATH"/qwificfg.txt"
