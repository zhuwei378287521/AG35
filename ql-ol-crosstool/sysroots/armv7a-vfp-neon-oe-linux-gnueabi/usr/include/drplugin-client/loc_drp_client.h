...
#ifdef LOG_DEBUG
#define DR_LOGV(...) ALOGV("DR_CLNT: V/" __VA_ARGS__)
#define DR_LOGD(...) ALOGD("DR_CLNT: D/" __VA_ARGS__)
#define DR_LOGI(...) ALOGI("DR_CLNT: I/" __VA_ARGS__)
#define DR_LOGW(...) ALOGW("DR_CLNT: W/" __VA_ARGS__)
#define DR_LOGE(...) ALOGE("DR_CLNT: E/" __VA_ARGS__)
