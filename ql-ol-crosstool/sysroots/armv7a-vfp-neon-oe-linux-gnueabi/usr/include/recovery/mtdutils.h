...
#if 1 //  quectel add mtd  wirte data to the specified block  start
ssize_t quectel_mtd_write_data(MtdWriteContext *ctx, off_t off_set, const char *data, size_t len);
#endif
