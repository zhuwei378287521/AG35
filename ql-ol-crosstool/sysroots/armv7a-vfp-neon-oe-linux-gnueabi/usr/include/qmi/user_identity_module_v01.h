...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/uim/api/user_identity_module_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Mar 29 2016 (Spin 0)
...
#define UIM_V01_IDL_MINOR_VERS 0x3D
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0069
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates the session type. \n Valid values -- 0 to 24.
       \n Refer to Table \ref{tbl:sessions} for available session types.
  */
 ...
 */
  ...
  /**<   Indicates whether profile needs to be enabled or disabled.
...
typedef enum {
  ...
  UIM_PROFILE_ICON_TYPE_NONE_V01 = 0x00, /**<  No icon info \n */
 ...
 */
  ...
  */
  ...
  /**<   Indicates the profile icon type. Valid values: \n
      - UIM_PROFILE_ICON_TYPE_NONE (0x00) --  No icon info \n
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Deletes the profile from card */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Deletes the profile from card */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Reset the memory of eUICC card */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Reset the memory of eUICC card */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Add a new profile to the eUICC card */
typedef struct {
 ...
 */
  ...
  */
  ...
  /**<   Indicate the confirmation code required for downloading
       the profile
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Add a new profile to the eUICC card */
typedef struct {
...
typedef enum {
   ...
   */
  UIM_DOWNLOAD_ERROR_CAUSE_SIM_V01 = 0x02, /**<  Profile download error from SIM card
   */
  UIM_DOWNLOAD_ERROR_CAUSE_NETWORK_V01 = 0x03, /**<  Profile download error from Netwok
   */
 ...
 */
  ...
  /**<   Indicates the cause of download error. Valid values:\n
      - UIM_DOWNLOAD_ERROR_CAUSE_GENERIC (0x01) --  Profile download generic error
  
      - UIM_DOWNLOAD_ERROR_CAUSE_SIM (0x02) --  Profile download error from SIM card
  
      - UIM_DOWNLOAD_ERROR_CAUSE_NETWORK (0x03) --  Profile download error from Netwok
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Update the profile nickname */
typedef struct {
 ...
 */
  ...
  /**<   Indicates new nickname that needs to be updated. If nickname
       TLV is missing, nickname will be removed from the profile.
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Update the profile nickname */
typedef struct {
