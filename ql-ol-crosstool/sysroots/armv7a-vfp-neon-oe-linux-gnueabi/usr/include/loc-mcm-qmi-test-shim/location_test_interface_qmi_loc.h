...
#ifndef LOCATION_TEST_INTERFACE_QMI_LOC_H
#define LOCATION_TEST_INTERFACE_QMI_LOC_H


#include "location_test_interface_base.h"

class location_test_interface_qmi_loc: public location_test_interface_base {

public:
    location_test_interface_qmi_loc();
    ~location_test_interface_qmi_loc();
...
#endif // LOCATION_TEST_INTERFACE_QMI_LOC_H
