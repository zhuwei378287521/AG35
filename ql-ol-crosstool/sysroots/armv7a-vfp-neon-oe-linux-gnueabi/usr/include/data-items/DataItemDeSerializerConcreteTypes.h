...
class BtLeDeviceScanDetailsDataItemDeSerializer : public DataItemDeSerializerBase {
public:
    BtLeDeviceScanDetailsDataItemDeSerializer (IDataItem * d);
    virtual int32 deSerialize (InPostcard * in);
    virtual ~BtLeDeviceScanDetailsDataItemDeSerializer ();
};

class BtDeviceScanDetailsDataItemDeSerializer : public DataItemDeSerializerBase {
public:
    BtDeviceScanDetailsDataItemDeSerializer (IDataItem * d);
    virtual int32 deSerialize (InPostcard * in);
    virtual ~BtDeviceScanDetailsDataItemDeSerializer ();
};
