...
class BtLeDeviceScanDetailsDataItemCopier : public DataItemCopierBase {
public:
    BtLeDeviceScanDetailsDataItemCopier (IDataItem * d);
    virtual int32 copy (IDataItem * src, bool *dataItemCopied = NULL);
    virtual ~BtLeDeviceScanDetailsDataItemCopier ();
};

class BtDeviceScanDetailsDataItemCopier : public DataItemCopierBase {
public:
    BtDeviceScanDetailsDataItemCopier (IDataItem * d);
    virtual int32 copy (IDataItem * src, bool *dataItemCopied = NULL);
    virtual ~BtDeviceScanDetailsDataItemCopier ();
};
