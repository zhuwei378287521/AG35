...
class BtLeDeviceScanDetailsDataItemSerializer : public DataItemSerializerBase {
public:
    BtLeDeviceScanDetailsDataItemSerializer (IDataItem *d);
    virtual int32 serialize (OutPostcard * out);
    virtual ~BtLeDeviceScanDetailsDataItemSerializer ();
};

class BtDeviceScanDetailsDataItemSerializer : public DataItemSerializerBase {
public:
    BtDeviceScanDetailsDataItemSerializer (IDataItem *d);
    virtual int32 serialize (OutPostcard * out);
    virtual ~BtDeviceScanDetailsDataItemSerializer ();
};
