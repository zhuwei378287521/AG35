...
class BtLeDeviceScanDetailsDataItemStringifier : public DataItemStringifierBase {
public:
    BtLeDeviceScanDetailsDataItemStringifier (IDataItem * d);
    virtual void stringify (string & valueStr);
    virtual ~BtLeDeviceScanDetailsDataItemStringifier ();
};

class BtDeviceScanDetailsDataItemStringifier : public DataItemStringifierBase {
public:
    BtDeviceScanDetailsDataItemStringifier (IDataItem * d);
    virtual void stringify (string & valueStr);
    virtual ~BtDeviceScanDetailsDataItemStringifier ();
};
