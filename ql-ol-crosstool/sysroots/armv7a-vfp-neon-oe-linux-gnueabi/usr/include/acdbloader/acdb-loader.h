...
//2014-12-05 add by scott.hu
void quectel_update_eec_parameters(int rxacdb_id, int txacdb_id, int idx, unsigned short val);
void quectel_get_eec_parameters(int rxacdb_id, int txacdb_id);
void quectel_acdb_set_sidetone(int enable, int gain);
//end scott.hu
