 ...
 */
#define CPPSTDIN "arm-oe-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon --sysroot=/home/ol/ws/P4V/Qualcomm/MDM9x28/OpenLinux/LE2.0.1/dev/apps_proc/poky/build/tmp-glibc/sysroots/mdm9607 -E"
#define CPPMINUS "-"
#define CPPRUN "arm-oe-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon --sysroot=/home/ol/ws/P4V/Qualcomm/MDM9x28/OpenLinux/LE2.0.1/dev/apps_proc/poky/build/tmp-glibc/sysroots/mdm9607 -E"
#define CPPLAST "-"
