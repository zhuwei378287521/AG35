...
#if defined(__QUECTEL_PROJECT_AG35C__) || defined(__QUECTEL_PROJECT_AG35CE__) || defined(__QUECTEL_PROJECT_AG35CEVBM__) || defined(__QUECTEL_PROJECT_AG35CEN__) || defined(__QUECTEL_PROJECT_AG35E__)
typedef enum{
    /*Invalid*/ PINNAME_BEGIN = -1,
	/*PIN-3*/  PINNAME_PMU_GPIO2 = 3,
    /*PIN-5*/  PINNAME_PMU_GPIO3 = 5,
	...
	/*PIN-169*/  PINNAME_PMU_GPIO6 = 169,
    /*PIN-170*/  PINNAME_PMU_GPIO1 = 170,
    /*PIN-171*/  PINNAME_PMU_GPIO4 = 171,
    PINNAME_END
}Enum_PinName;
#else
typedef enum{
